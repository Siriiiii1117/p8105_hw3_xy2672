...
<img src="p8105_hw3_xy2672_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />

Based on the education table by sex and the age distribution by
education level and sex, there is not much difference on the education
level between the two sexes. More than high school education level is
the most common education level among the participants.
...
<img src="p8105_hw3_xy2672_files/figure-gfm/unnamed-chunk-15-1.png" width="90%" />

Based on the plot, we can see that as people age, the total daily
activity decreases. From the smooth line, participants whose educational
level are less than high school do not show differences in sex. For
participants who have high school or more educational level, females
tend to have more total daily activity.
...
<img src="p8105_hw3_xy2672_files/figure-gfm/unnamed-chunk-16-1.png" width="90%" />

Based on this graph, we can conclude that the peak activity happens at
noon (peak at 12, and high from 10 to 15). Looking at the raw data, we
also see that activity starts to decline at around 18:00 to 19:00 and
starts decrease from 5:00. In addition, the mean activity per hour does
not show significant differences between the three educational levels,
but women who have high school or more educational level tends to have
higher activity (which is also shown in the graph above).
